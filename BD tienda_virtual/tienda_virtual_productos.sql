...
CREATE TABLE `productos` (
  ...
  `ivacompra` decimal(15,0) NOT NULL,
  `nitproveedor` int NOT NULL,
  `nombre_producto` varchar(255) DEFAULT NULL,
  `precio_compra` decimal(15,0) NOT NULL,
  `precio_venta` decimal(15,0) NOT NULL,
  PRIMARY KEY (`codigo_producto`),
  KEY `fk nitproveedor` (`nitproveedor`),
  CONSTRAINT `fk nitproveedor` FOREIGN KEY (`nitproveedor`) REFERENCES `proveedores` (`nitproveedor`)
